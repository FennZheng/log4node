...
(function() {
  var conf, funLog, logger1, logger2;
    ...
    "loggers": [
      {
        "name": "example1",
        "level": "off",
        "appenderRefs": ["sentryAppender", "consoleAppender", "example1RollingFileAppender"]
      }, {
        "name": "deliver",
        "level": "debug",
        "appenderRefs": ["sentryAppender", "consoleAppender", "example2RollingFileAppender"]
      }
    ]
  };
